...
//   reader->AddVariable( "nmhits", &nmhits_c );
   ...
   TString dir="/work/submit/juliush/UROP_darkphoton/make_intermediate_ntuples/mva/"+fold[type-1]+"/";
...
void add_mva(string treepath = "small_intermediate_mva.root", int year=2018, bool isMC=true) {
