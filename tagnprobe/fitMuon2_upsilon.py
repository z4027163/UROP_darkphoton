...
Template = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    Variables = cms.PSet(
        mass = cms.vstring("Tag-muon Mass", "8", "12", "GeV/c^{2}"),
    ...
    #    )
         voigtPlusExpo = cms.vstring(
            "Voigtian::signal1(mass, mean1[9.5,9.2,9.7], width1[0.2,0.05,0.5], sigma1[0.2,0.05,0.5])".replace("mass",mass_),
            "Voigtian::signal2(mass, mean2[10,9.7,10.2], width2[0.1,0.05,0.2],        sigma2[0.1,0.05,0.15])".replace("mass",mass_),
            "Voigtian::signal3(mass, mean3[10.4,10.2,10.6], width3[0.1,0.03,0.2],        sigma3[0.1,0.05,0.15])".replace("mass",mass_),
            "SUM::signal(signal1, vFrac1[0.5,0.2,1]*signal2,vFrac2[0.1,0.05,0.2]*signal3)",
...
for ID, ALLBINS in ID_BINS:
    ...
    shutil.copyfile(os.getcwd()+'/fitMuon2_upsilon.py',_output+'/fitMuon2_upsilon.py')
